...
-- messages
L.message_welcome		= "Введите /ctm для настройки."
L.message_leader		= "Вы должны быть лидером группы или иметь статус помощника, чтобы сделать это."
L.message_outdated		= "Доступна новая версия CTM/ThreatClassic-1.0! Пожалуйста, загрузите последнюю версию."
L.message_incompatible	= "CTM/ThreatClassic-1.0 устарела и не будет совместима с этой группой. Пожалуйста, обновите немедленно."
