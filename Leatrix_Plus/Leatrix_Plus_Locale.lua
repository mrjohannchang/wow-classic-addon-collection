...
L["Battle of Angrathar the Wrathgate"] = "Ангратар, Врата Гнева"
...
L["Block friend requests"] = "Блокировать запросы дружбы"
L["Block party invites"] = "Блокировать приглашения в группу"
L["Blocks"] = "Блоки"
...
L["Disable chat fade"] = "Отключить затемнение сообщений чата"
L["Disable loot warnings"] = "Отключить предупреждения о добыче"
L["Disable screen effects"] = "Отключить эффекты"
L["Disable screen glow"] = "Отключить свечение "
...
L["Drag to set the cursor X offset."] = "Перетащите, чтобы установить по X курсора."
L["Drag to set the cursor Y offset."] = "Перетащите, чтобы установить смещение по Y."
L["Drag to set the font size of mail text."] = "Перетащите, чтобы установить размер шрифта в письмах."
L["Drag to set the font size of quest text."] = "Перетащите, чтобы установить размер шрифта текста в квестах."
L["Drag to set the minimap scale.|n|nNote that if you are using the default action bars, rescaling the minimap will also rescale the right action bars at startup so you may want to leave this at 100%."] = "Перетащите, чтобы масштабировать мини-карту. Обратите внимание, что если вы используете панели действий по умолчанию, то изменения масштаба миникарты также приведут к изменению их масштаба, так что можете оставить значение на 100%."
L["Drag to set the scale of the Leatrix Plus panel."] = "Перетащите, чтобы установить масштаб панели Leatrix Plus."
L["Drag to set the scale of the selected frame."] = "Перетащите, чтобы установить масштаб выбранного фрейма."
...
L["Enhance dressup"] = "Улучшенная модель"
...
L["Hide level-up display"] = "Скрыть окно повышения уровня"
L["Hide portrait numbers"] = "Скрыть числа на портрете"
L["Hide social button"] = "Скрыть кнопку общения"
L["Hide stance bar"] = "Скрыть панель стоек"
L["Hide the clock"] = "Скрыть часы"
L["Hide the combat log"] = "Скрыть журнал боя"
L["Hide the zone text bar"] = "Скрыть уровень локации"
L["Hide the zoom buttons"] = "Скрыть кнопки приближения"
...
L["If checked, a button will be added to the character sheet which will show your equipped item durability when you hover the pointer over it.|n|nIn addition, an overall percentage will be shown in the chat frame when you die."] = "Если стоит галочка, то в окне персонажа будет добавлена кнопка, которая покажет прочность экипировки при наведении на нее.Кроме этого, общий процент будет показан в окне чата, если Вы умрете."
L["If checked, a group invite will be sent to anyone who whispers you with the keyword INV.|n|nYou need to be either ungrouped or party leader in your own group for this to work."] = "Если стоит галочка, то групповое приглашение будет отправлено всем, кто шепчет вам с ключевым словом INV. Чтобы это сработало, вы должны быть не в группе, либо лидером группы."
L["If checked, a master volume slider will be shown in the character sheet."] = "Если стоит галочка, то ползунок общей громкости будет отображаться на панели информации о персонаже."
L["If checked, a minimap button will be available.|n|nClick - Toggle options panel.|n|nSHIFT/Left-click - Toggle music.|n|nCTRL/Right-click - Toggle errors (if enabled).|n|nCTRL/SHIFT/Left-click - Toggle Zygor (if installed).|n|nCTRL/SHIFT/Right-click - Toggle windowed mode."] = [=[Если стоит галочка, то будет доступна кнопка на миникарте. Кликните - чтобы вкл/выкл опции. SHIFT/ЛКМ - вкл/выкл музыку. CTRL / ПКМ - вкл/выкл ошибки (если были включены). CTRL / SHIFT / ЛКМ - вкл/выкл Zygor (если установлен).CTRL / SHIFT / ПКМ - вкл/выкл оконный режим.  
]=]
L["If checked, additional functionality will be added to the auction house.|n|nBuyout only - create buyout auctions without filling in the starting price.|n|nGold only - set the copper and silver prices at 99 to speed up new auctions.|n|nFind item - search the auction house for the item you are selling.|n|nIn addition, the auction duration setting will be saved account-wide."] = "Если стоит галочка, то на аукцион будут добавлены новые функции. Только выкуп - создание аукционов выкупа без указания начальной цены. Только золото - установите цены на медь и серебро 99, чтобы ускорить продажу новых лотов. Найти предмет - найдите в аукционе предмет, который вы продаете. Кроме того, настройка длительность лотов будет сохранена для всего аккаунта"
L["If checked, alert frames will not be shown."] = "Если стоит галочка, то фрейм предупреждения не будут отображаться."
L["If checked, all grey items in your bags will be sold automatically when you visit a merchant.|n|nYou can hold the shift key down when you talk to a merchant to override this setting."] = "Если стоит галочка, то все серые предметы в Ваших сумках будут проданы автоматически при посещении торговца.|n|nВы можете удерживать клавишу SHIFT во время общения с торговцем для временного игнорирования этой опции."
L["If checked, backdrops will be tinted blue (friendly) or red (hostile)."] = "Если стоит галочка, то фон подсказки будет синим (дружественная цель) или красным (враждебная цель)."
L["If checked, BattleTag and Real ID friend requests will be automatically declined.|n|nEnabling this option will automatically decline any pending requests."] = "Если стоит галочка, то BattleTag и Real ID запросы дружбы будут автоматически отклоняться.|n|nВключение этого параметра автоматически отклонит любые ожидающие запросы."
L["If checked, chat frame buttons will be hidden.|n|nClicking chat tabs will automatically show the latest messages.|n|nUse the mouse wheel to scroll through the chat history.  Hold down SHIFT for page jump or CTRL to jump to the top or bottom of the chat history."] = "Если стоит галочка, то кнопки чата будут скрыты.|n|nЩелчек по вкладке чата автоматически покажет последние сообщения.|n|nИспользуйте колесо мыши для прокрутки истории чата. Удерживайте клавишу SHIFT для перехода на другую страницу чата или CTRL, для перехода к верхней или нижней части истории чата."
L["If checked, chat text will not fade out after a time period."] = "Если стоит галочка, то текст чата не будет исчезать спустя время."
L["If checked, class coloring will be used in the player frame and target frame."] = "Если стоит галочка, то цвет по классам будет не только на фрейме игрока, но и на цели."
L["If checked, class colors will be used in the chat frame."] = "Если стоит галочка, то цвета классов будут использоваться в чате."
L["If checked, confirmations will no longer appear when you choose a loot roll option or attempt to sell or mail a tradable item."] = "Если стоит галочка, то больше не будет предупреждений когда вы ролите предмет или пересылаете по почте предмет, который можно передать."
L["If checked, cooldown duration numbers will not be shown over the cooldowns.|n|nIf unchecked, cooldown duration numbers will be shown over the cooldowns if they are enabled in the game options panel ('ActionBars' menu)."] = "Если стоит галочка, то не будут отображаться цифры перезарядки.|n|nЕсли галочка не стоит, то цифры будут показываться поверх перезарядки (если они вкл. в игровых настройках)."
L["If checked, crafted items will no longer show the name of the crafter."] = "Если стоит галочка, не показывает имя изготовителя на вещи."
L["If checked, damage and healing numbers in the player and pet portrait frames will be hidden."] = "Если стоит галочка, то цифры урона и лечения на фреймах игрока и питомца будут скрыты."
L["If checked, dragging the General chat tab while the chat frame is locked will expand the chat frame upwards.|n|nIf the chat frame is unlocked, dragging the General chat tab will move the chat frame."] = "Если стоит галочка, то при перетягивании  вкладки \"Общие\" (если окно чата заблокировано) расширит чат.|n|nЕсли окно чата разблокировано, то перетягивание вкладки \"Общие\" приведет к перемещению окна чата."
L["If checked, duel requests will be blocked unless the player requesting the duel is in your friends list or guild."] = "Если стоит галочка, то запросы на дуэль будут заблокированы (кроме запросов из вашей гильдии и из списка друзей)."
L["If checked, emote sounds will be silenced while your character is resting or at the Grim Guzzler.|n|nEmote sounds will be enabled at all other times."] = "Если стоит галочка, то звуки эмоций будут заглушаться, пока ваш персонаж отдыхает или находится в Трактир \"Угрюмый обжора\".|n|nВ любое другое время звуки будут включены."
L["If checked, enemy nameplates will be shown during combat and hidden when combat ends."] = "Если стоит галочка, то индикаторы здоровья будут отображены только во время боя и скрыты после его завершения."
L["If checked, guild names will be shown.  Guild ranks will also be shown for players in your guild."] = "Если стоит галочка, то будут показываться гильдейские имена. Ранги в гильдии будут так же показываться для согильдийцев."
L["If checked, most error messages (such as 'Not enough rage') will not be shown.  Some important errors are excluded.|n|nIf you have the minimap button enabled, you can hold down the control key and right-click it to toggle error messages without affecting this setting."] = "Если стоит галочка, то большинство сообщений об ошибках (например, «Недостаточно ярости») не будут отображаться. Некоторые важные ошибки останутся.|n|nЕсли у вас включена кнопка на мини-карте, вы сможете удерживать CTRL и нажать ПКМ, чтобы  вкл/выкл сообщения ошибка, не трогая данную настройку."
L["If checked, nude and tabard toggle buttons will be added to the dressup frame and model rotation controls will be removed."] = "Если стоит галочка, то появится кнопка которая скрывает/включает вещи и накидку в режиме примерки и удаляет другие элементы управления."
L["If checked, party invitations from friends or guild members will be automatically accepted."] = "Если стоит галочка, то приглашения в группу или гильдию будут приниматься автоматически."
L["If checked, party invitations will be blocked unless the player inviting you is in your friends list or guild."] = "Если стоит галочка, то приглашения в группу будут заблокированы, если игрок, приглашающий вас, не будет в вашем списке друзей или гильдии."
L["If checked, quests will be selected, accepted and turned-in automatically.|n|nQuests which have a gold requirement will not be turned-in automatically.|n|nYou can hold the shift key down when you talk to a quest giver to override this setting."] = "Если стоит галочка, то квесты будут приниматься и завершаться автоматически.|n|nКвесты где нужно золото не будут автоматически завершаться.|n|nВы так же можете удерживать клавишу Shift, перед тем как говорить с НПС, чтобы временно игнорировать данную настройку."
L["If checked, raid chat and instance chat will both be colored blue (to match the default party chat color)."] = "Если стоит галочка, то чаты рейдов и подземелий будут окрашены в синий цвет (чтобы они сочетались по цвету)."
L["If checked, resurrection requests will be accepted automatically as long as the player resurrecting you is not in combat."] = "Если стоит галочка, то подтверждение воскрешения будет происходить автоматически, за исключением, если игрок который вас воскресил не находится в бою."
L["If checked, spell IDs will be shown in buff icon tooltips located in the buff frame and under the target frame."] = "Если стоит галочка, то  во всплывающих подсказках на фрейме с бафами, а также на целях персонажа будут отображаться ID заклинаний. "
L["If checked, sticky chat will be disabled.|n|nNote that this does not apply to temporary chat windows."] = "Если стоит галочка, то \"липкий\" чат будет отключен.|n|n Заметка! Данная настройка не будет работать для временных чатов."
L["If checked, summon requests will be accepted automatically unless you are in combat."] = "Если стоит галочка, то запросы призыва будут подтверждаться автоматически, если вы не в бою."
L["If checked, the addon list (accessible from the game menu) will show character based addons by default."] = "Если стоит галочка, то список модификаций (доступный из меню игры) будет отображать список модификации для данного персонажа по умолчанию."
L["If checked, the amount of time it takes to auto loot creatures will be significantly reduced."] = "Если стоит галочка, то время поднятие добычи значительно уменьшится."
L["If checked, the backpack clean-up button and the bank frame clean-up button will not be shown."] = "Если стоит галочка, то кнопка сортировки вещей в сумках и в банке не будет отображаться."
L["If checked, the boss banner will not be shown.|n|nThe boss banner appears when a boss is defeated.  It shows the name of the boss and the loot that was distributed."] = "Если стоит галочка, то баннер босса отображаться не будет.|n|nЭтот баннер обычно появляется после победы над боссом (показывает имя босса и добычу с него)."
L["If checked, the button to toggle the raid container frame will be shown just above the raid management frame (left side of the screen) instead of in the raid management frame itself.|n|nThis allows you to toggle the raid container frame without needing to open the raid management frame."] = "Если стоит галочка, то кнопка для переключения контейнера рейд будет отображена над его окном управления (c левой стороны), а не на самом окне управления.|n|nЭто позволит переключать рамку контейнера рейда без необходимости открывать окно его управления."
L["If checked, the clock will be hidden."] = "Если стоит галочка, то часы не будут отображаться."
L["If checked, the combat log will be hidden.|n|nThe combat log must be docked in order for this option to work.|n|nIf the combat log is undocked, you can dock it by dragging the tab (and reloading your UI) or by resetting the chat windows (from the chat menu)."] = "Если стоит галочка, то журнал боя будет скрыт.|n|n Чтобы данная настройка работал журнал боя должен быть присоединён к чату.|n|n Если журнал боя откреплён, Вы можете закрепить его перетащив на вкладку чата (после этого необходимо перезагрузить UI) или сбросить настройки окна чата (из соответствующего меню)."
L["If checked, the 'Display only character achievements to others' setting in the game options panel ('Social' menu) will be permanently checked and locked."] = "Если стоит галочка, то параметр 'Позволить другим просматривать только достижения персонажа' будет постоянно включен и заблокирован."
L["If checked, the editbox will be moved to the top of the chat frame."] = "Если стоит галочка, то поле ввода текста будет перемещено в верхнюю часть окна чата."
L["If checked, the game world will be resized to fit between the top and bottom borders.|n|nNote that if you enable this setting, the transparency slider will no longer affect the top and bottom borders."] = "Если стоит галочка, то размер игрового мира будет изменен в соответствии с верхней и нижней рамкой.|n|n Заметка!  Если вы включили данную настройку, то уровень прозрачности больше не будет влиять на верхнюю и нижнюю рамку."
L["If checked, the gossip window will not be shown when you talk to an active garrison bodyguard.|n|nYou can hold the shift key down when you talk to a bodyguard to override this setting."] = "Если стоит галочка, то окно разговоров не будет отображаться, когда Вы будете говорить с активным гарнизонным телохранителем.|n|nВы можете удерживать клавишу SHIFT во время общения для временного игнорирования данной настройки."
L["If checked, the grey screen of death and the netherworld effect will be disabled."] = "Если стоит галочка, то серый экран смерти и другие эффекты будут отключены."
L["If checked, the level-up display will not be shown.|n|nThe level-up display shows encounter objectives, level-ups, pet battle rewards, etc."] = "Если стоит галочка, то окно увеличения уровня не будет отображаться.|n|nЭто окно обычно отображает цели подземелья, повышение уровня, награды за битву питомцев и др."
L["If checked, the main bar gryphons will not be shown."] = "Если стоит галочка, то панель с грифонами не будет отображаться."
L["If checked, the screen glow will be disabled.|n|nEnabling this option will also disable the drunken haze effect."] = "Если стоит галочка, то свечение экрана будет отключено.|n|nВключение этой опции также отключит эффект \"пьяной\" дымки."
L["If checked, the stance bar will not be shown."] = "Если стоит галочка, то панель стоек не будет отображаться."
L["If checked, the talking frame will not be shown.|n|nThe talking frame normally appears in the lower portion of the screen when certain NPCs communicate with you."] = "Если стоит галочка, то окно разговоров не будет показываться.|n|nОкно разговоров появляется обычно в нижней части экрана, в процессе общения с некоторыми НПС."
L["If checked, the tooltip will be color coded and you will be able to modify the tooltip layout and scale."] = "Если стоит галочка, то всплывающие подсказки будут выделяться цветом, и у Вас появится возможность менять ее расположение и размер."
L["If checked, the vendor price will be shown in item tooltips."] = "Если стоит галочка, то цена у продавца будет отображаться во всплывающих подсказках."
L["If checked, the zone text bar will be hidden.  The tracking button tooltip will show zone information."] = "Если стоит галочка, то название зоны будет скрыто (но все ещё будет появляться во всплывающей подсказке)."
L["If checked, the zoom buttons will be hidden.  You can use the mousewheel to zoom regardless of this setting."] = "Если стоит галочка, то кнопки масштаба будут скрыты, но вы сможете использовать колесо мыши для увеличения независимо от этой настройки."
L["If checked, tooltips for world units will be hidden during combat.|n|nYou can hold the shift key down to override this setting."] = "Если стоит галочка, то подсказки для мировых боссов будут скрыты во время боя.|n|nВы можете удерживать клавишу SHIFT для временного игнорирования этой настройки."
L["If checked, unit targets will be shown."] = "Если стоит галочка, то будет отображаться цель цели."
L["If checked, Wowhead links will be shown above the quest log frame."] = "Если стоит галочка, то над квест фреймом будут отображаться ссылки на Wowhead."
L["If checked, you can hold down the alt key while opening a gossip window to automatically select a single gossip item.|n|nIf the gossip item type is banker, taxi, trainer or vendor, gossip will be skipped without needing to hold the alt key.  You can hold the shift key down to prevent this."] = "Если стоит галочка, то вы можете удерживать клавишу Alt при открытии окна c разговорами, чтобы автоматически выбрать один вариантов диалога.|n|nЕсли тип диалога - это банкир, распорядитель полетов, тренер или продавец, диалоги будут пропущены без необходимости удерживать клавишу Alt. Вы так же можете удерживать клавишу Shift, чтобы временно отключить данную настройку."
L["If checked, you can hold down the control key and click a chat tab to view recent chat in a copy-friendly window."] = [=[Если стоит галочка, то вы можете удерживать нажатой клавишу управления и щелкнуть 
на вкладку чата, чтобы просмотреть недавний чат в окне, в котором вы сможете легко скопировать текст.]=]
L["If checked, you can open Leatrix Plus by pressing CTRL/Z."] = "Если стоит галочка, то вы сможете открыть Leatrix Plus, нажав CTRL/Z."
L["If checked, you can press the arrow keys to move the insertion point left and right in the chat frame.|n|nIf unchecked, the arrow keys will use the default keybind setting."] = "Если стоит галочка, то Вы сможете нажимать кнопки со стрелками для перемещения курсора влево и вправо в окне чата.|n|nЕсли галочка не стоит, то клавиши со стрелками будут использовать настройки назначения клавиш по умолчанию."
L["If checked, you will be able to cancel cinematics without being prompted for confirmation."] = "Если стоит галочка, то вы сможете пропускать ролики без подтверждения."
L["If checked, you will be able to change the font size of quest text."] = "Если стоит галочка, то вы сможете изменять размер шрифта текста квестов."
L["If checked, you will be able to change the font size of standard mail text.|n|nThis does not affect mail created using templates (such as auction house invoices)."] = "Если стоит галочка, то Вы сможете изменить стандартный размер шрифтов текста писем."
L["If checked, you will be able to change the position and scale of the following frames:|n|n- Player frame|n- Target frame|n- Buffs frame|n- Widget top center frame|n- Timer bar"] = "Если установлен этот флажок, вы сможете изменить положение и масштаб следующих кадров:|n|n- рамка игрока|n- Целевая рамка|n- Баффы рамы|n- Виджет верхней центральной рамы|n- Таймер"
L["If checked, you will be able to create a viewport.  A viewport adds adjustable black borders around the game world.|n|nThe borders are placed on top of the game world but under the UI so you can place UI elements over them."] = "Если стоит галочка, то Вы сможете создать темные полосы. Они накладываются на сверху и снизу экрана.|n|nНа них вы сможете поместить ваш интерфейс."
L["If checked, you will be able to customise the minimap."] = "Если стоит галочка, то вы сможете настроить миникарту."
L["If checked, you will be able to drag the chat frame to the edge of the screen."] = "Если стоит галочка, то Вы сможете переместить фрейм чата к краю экрана."
L["If checked, you will be able to place up to five beneficial cooldown icons above the target frame."] = "Если стоит галочка, то вы сможете разместить до пяти иконок восстановления над  фреймом цели."
L["If checked, you will be able to reposition the tooltip."] = "Если стоит галочка, то вы сможете изменить положение всплывающей подсказки."
L["If checked, you will be able to show a rare, elite or rare elite chain around the player frame."] = "Если стоит галочка, то Вы сможете добавить вокруг рамки игрока элитный или редкий (редко-элитный) контур."
L["If checked, you will be able to zoom out to a greater distance."] = "Если стоит галочка, то Вы сможете максимально далеко отдалять камеру."
L["If checked, you will release automatically after you die in a battleground.|n|nYou will not release automatically if you have the ability to self-resurrect."] = "Если стоит галочка, то вы будете автоматически покидать тело после смерти на поле битвы.|n|n Но если у вас есть возможность самовоскрешения, то данная настройка не подействует."
L["If checked, your bags will not be opened or closed automatically when you interact with a merchant, bank or mailbox."] = "Если стоит галочка, то Ваши сумки не будут открываться или закрываться автоматически, когда Вы взаимодействуете с торговцами, банком или почтовым ящиком."
L["If checked, your character will automatically stand or dismount when an action is prevented because you are either seated or mounted."] = "Если стоит галочка, то ваш персонаж будет автоматически вставать или спешиваться, когда действие будет предотвращено, в связи с тем, что вы уже сидите или находитесь на ездовом животном."
L["If checked, your chat history will increase to 4096 lines.  If unchecked, the default will be used (128 lines).|n|nEnabling this option may prevent some chat text from showing during login."] = "Если стоит галочка, то история чата увеличится до 4096 строк. Если галочка не установлена, то по умолчанию будет использоваться (128 строк).|n|nВключение этой настройки может помешать отображению некоторого текста во время входа в систему."
...
L["If checked, zone text will not be shown (eg. 'Ironforge')."] = "Если стоит галочка, то текст названия зоны не будет отображаться (например \"Стальгорн\")."
...
L["Missing movie ID."] = "ID ролика не найден."
L["Missing quest ID."] = "ID квеста не найден."
...
L["Move editbox to top"] = "Переместить окно редактирования вверх"
L["Movie not playable."] = "Ролик не воспроизводится."
L["Movie number"] = "Номер ролика"
L["Movies"] = "Ролики"
L["Mulgore"] = "Мулгор"
L["Music"] = "Музыка"
L["Music Rolls"] = "Музыкальные темы"
L["Nagrand"] = "Награнд"
...
L["Release in PvP"] = "Выйти из тела в PvP"
L["Reload"] = "Перезагрузить"
L["Repair automatically"] = "Автоматический ремонт"
L["Repair Automatically"] = "Автоматический ремонт"
L["Repair using guild funds if available"] = "Использование для ремонт средств гильдии, если доступны"
...
L["Requires you to be interacting with Larana Drome.  She can be found at Scribes' Sacellum, Dalaran, Northrend."] = "Требуется, чтобы вы поговорили с Лараной Дром. Ее можно найти в Даларан (Нордскол)."
L["Reset"] = "Сбросить"
L["Resize mail text"] = "Изменить размер текста сообщения"
L["Resize quest text"] = "Изменить размер текста задания"
...
L["Show durability status"] = "Отображать прочность экипировки"
L["Show guild names"] = "Показать названия гильдий"
L["Show minimap button"] = "Отображать иконку у миникарты"
L["Show pet save button"] = "Показать кнопку сохраненных питомцев"
L["Show player chain"] = "Отображать контур игрока"
...
L["Show volume slider"] = "Отображать ползунок громкости"
...
L["The Burning Crusade"] = "Пылающий Легион"
...
L["Uldaman"] = "Ульдаман"
L["Ulduar"] = "Ульдуар"
L["Unclamp chat frame"] = "Освободить окно чата"
L["Underbog"] = "Нижетопь"
...
L["Use easy resizing"] = "Использовать легкое изменение размера"
...
L["You have"] = "У Вас"
L["Your UI needs to be reloaded for some of the changes to take effect.|n|nYou don't have to click the reload button immediately but you do need to click it when you are done making changes and you want the changes to take effect."] = "Вам нужно перезагрузить UI, чтобы в работу вступили часть принятых изменений.|n|nМожете делать этого сразу это не сразу, а когда закончите работу с настройками."
...
L["If checked, the per unit vendor price will be shown in item tooltips."] = "상점 판매 가격이 아이템 툴팁에 표시 됩니다."
...
L["If checked, the shaman class color will be changed from pink to blue."] = "주술사 직업 색상이 분홍색에서 파란색으로 바뀝니다."
