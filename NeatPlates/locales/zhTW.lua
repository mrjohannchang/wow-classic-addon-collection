...
L["Hide in instances, Show outside of instances"] = "在副本中隱藏，在副本外顯示"
...
L["Only uses the 'Mid Range' & 'Out of Range' colors to indicate unit range"] = "只使用 '中間範圍' & '超出範圍' 顏色來指示單位的範圍距離"
L["Opacity"] = "不透明度"
L["Other Colors"] = "其他顏色"
...
L["Show Duration on Cast Bars"] = "施法條顯示持續時間"
...
L["Use Custom Target Color"] = "使用自訂選取目標顏色"
...
L["Uses multiple colors to indicate unit range"] = "使用多種顏色來指示單位的範圍距離"
